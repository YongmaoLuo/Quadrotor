...
OBJECTS += ./mbed-os/features/netsocket/emac-drivers/TARGET_NXP_EMAC/TARGET_LPCTarget/lpc17_emac.o
OBJECTS += ./mbed-os/features/netsocket/emac-drivers/TARGET_NXP_EMAC/TARGET_LPCTarget/lpc_phy_dp83848.o
...
OBJECTS += ./mbed-os/rtos/source/TARGET_CORTEX/rtx5/RTX/Source/TOOLCHAIN_GCC/TARGET_M3/irq_cm3.o
...
INCLUDE_PATHS += -I../C:/GitHub/Quadrotor/mbed-os
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1591701605.393261
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1591701605.393261
...
ASM_FLAGS += -I..\mbed-os\features\netsocket
ASM_FLAGS += -I..\mbed-os\features\netsocket\cellular
ASM_FLAGS += -I..\mbed-os\features\netsocket\emac-drivers\TARGET_NXP_EMAC\TARGET_LPCTarget
ASM_FLAGS += -I..\mbed-os\features\netsocket\ppp
...
ASM_FLAGS += -I..\mbed-os\targets\TARGET_NXP
ASM_FLAGS += -I..\mbed-os\targets\TARGET_NXP\TARGET_LPC176X
ASM_FLAGS += -I..\mbed-os\targets\TARGET_NXP\TARGET_LPC176X\TARGET_MBED_LPC1768
ASM_FLAGS += -I..\mbed-os\targets\TARGET_NXP\TARGET_LPC176X\device
ASM_FLAGS += -IC:\GitHub\Quadrotor\mbed-os
ASM_FLAGS += -include
...
LD_FLAGS :=-Wl,--gc-sections -Wl,--wrap,main -Wl,--wrap,_malloc_r -Wl,--wrap,_free_r -Wl,--wrap,_realloc_r -Wl,--wrap,_memalign_r -Wl,--wrap,_calloc_r -Wl,--wrap,exit -Wl,--wrap,atexit -Wl,-n -mcpu=cortex-m3 -mthumb -DMBED_ROM_START=0x0 -DMBED_ROM_SIZE=0x80000 -DMBED_RAM_START=0x10000000 -DMBED_RAM_SIZE=0x8000 -DMBED_RAM1_START=0x2007c000 -DMBED_RAM1_SIZE=0x8000 -DMBED_BOOT_STACK_SIZE=1024 -DXIP_ENABLE=0 
